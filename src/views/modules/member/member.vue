<template>
  <div class="mod-config">
    ...
    >
      ...
      <!-- <el-table-column prop="header" header-align="center" align="center" label="头像" width="50"></el-table-column> -->
      <el-table-column prop="gender" header-align="center" align="center" label="性别" width="40"></el-table-column>
